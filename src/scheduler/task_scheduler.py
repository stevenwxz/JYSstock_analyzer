...
from config.config import SCHEDULE_CONFIG
...
class TaskScheduler:
    ...
    def is_trading_day(self) -> bool:
        ...
        year_holidays = holidays_by_year.get(today.year, set())
        today_str = today.strftime('%m-%d')
        if today_str in year_holidays:
            return False
