...
- **估值 (25分)**: PE(<10→10分), PB(<2→10分,<7→5分,对成长股更友好), PEG(<1→5分)
- **盈利能力 (30分)**: ROE(>20%→15分)、利润增长率(>30%→15分)
- **安全性 (10分)**: PB安全边际(<1.0→3分,范围严格), 股息率(>5%→3分), 换手率(<2%→4分,权重增加)
- **股息 (5分)**: 股息率得分(>5%→5分)

**v4.4关键优化**:
- PE按10,20,30划分,更符合市场估值
- PB估值放宽至<10都给分,权重增加至10分
- PB安全边际严格化(<2.5才给分),权重降至3分
- 明确区分"估值合理性"和"安全边际"概念
- 换手率权重增加至4分,补偿真实数据权重
